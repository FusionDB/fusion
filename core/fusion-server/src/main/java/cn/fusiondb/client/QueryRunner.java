...
import static io.trino.client.OkHttpUtil.*;
        ...
        implements Closeable
{
    ...
    {
        return startInternalQuery(ClientSession.stripTransactionId(session.get()), query);
    }
    ...
    private StatementClient startInternalQuery(ClientSession session, String query)
    {
        ...
        return StatementClientFactory.newStatementClient(client, session, query);
    }
